...
//generate user_id
    ...
    public function save_observation() {
        ...
        $export_sale_observation = nl2br($this->input->post('export_sale_observation'));
        $export_sale_remarks = nl2br($this->input->post('editor_export_sales'));
        $gstr3b_account_observation = nl2br($this->input->post('gstr3b_account_observation'));
        $gstr3b_account_remarks = nl2br($this->input->post('editor_duedate_gstr2a'));
        ...
        $invoice_not_remarks = nl2br($this->input->post('editor_invoice_not_include'));
        $amend_observation = nl2br($this->input->post('amend_observation'));
        $amend_remarks = nl2br($this->input->post('editor_ammend'));
        $not_in_2a_observation = nl2br($this->input->post('not_in_2a_observation'));
        $not_in_2a_remarks = nl2br($this->input->post('editor_not_in_2a'));
        $not_in_record_observation = nl2br($this->input->post('not_in_record_observation'));
        $not_in_record_remarks = nl2br($this->input->post('editor_not_in_record'));
        $partially_match_observation = nl2br($this->input->post('partially_match_observation'));
        $partially_match_remarks = nl2br($this->input->post('editor_partially_match'));
...
//        }
            ...
            $data = array(
                ...
                'export_sale_observation' => $export_sale_observation,
                'export_sale_remarks' => $export_sale_remarks,
                'duedate_gstr2a_observation' => $gstr3b_account_observation ,
                'duedate_gstr2a_remarks' => $gstr3b_account_remarks,
                ...
                'invoice_not_include_remarks' => $invoice_not_remarks,
                'amendment_records_observation' => $amend_observation,
                'amendment_records_remarks' => $amend_remarks,
                'not_in_2a_observation' => $not_in_2a_observation,
                'not_in_2a_remarks' => $not_in_2a_remarks,
                'not_in_record_observation' => $not_in_record_observation,
                'not_in_record_remarks' => $not_in_record_remarks,
                'partially_match_observation' => $partially_match_observation,
                'partially_match_remarks' => $partially_match_remarks,
