        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.report_sts == '1') {
                    window.location.href = "<?= base_url() ?>update_detail_hq/" + btoa(customer_id) + "/" + btoa(insert_id);
                } else {
                    window.location.href = "<?= base_url() ?>enter_detail_hq/" + btoa(customer_id) + "/" + btoa(insert_id);
                }
            }
        });
    }
