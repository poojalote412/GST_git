...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Invoices amended in other than original period
            <!--<small>it all starts here</small>-->
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <!--            <li><a href="#">Examples</a></li>-->
            <li class="active">Invoices amended</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
//                                    var_dump($cfo_data);
                        if ($invoice_amend_data !== "") {
                            $i = 1;
                            foreach ($invoice_amend_data as $row) {
                                ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $row->customer_name; ?></td>
                                    <td>
                                        <a type="button" class="btn btn-default" name="get_records" id="get_records" onclick="get_records_ammend('<?php echo $row->customer_id; ?>', '<?php echo $row->insert_id; ?>');"><i class="fa fa-eye"></i> view</a>
                                    </td>
                                </tr> 
                                <?php
                                $i++;
...
<script>
    ...
    //get data of customer firm wise
     ...
     function get_sorted_data() {
        ...
        window.location.href = "<?= base_url("Invoice_comp_report/hq_view_customers_ammend/") ?>" + firm_id_fetch;
    ...
    $("#import").click(function (event) {
        ...
        $.ajax({
            url: "<?= base_url("Invoice_comp_report/import_amendment_excel") ?>",
            type: "POST",
    ...
    function get_records_ammend(customer_id, insert_id)
    {
        $('#company_data').html("");
        $.ajax({
            type: "post",
