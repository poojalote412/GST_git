...
<script>
    ...
    //get data of customer firm wise
     ...
     function get_sorted_data() {
        ...
        window.location.href = "<?= base_url("Invoice_comp_report/hq_view_customer/") ?>" + firm_id_fetch;
    ...
    //Get all not in 2A records with company datails for report
    
    function get_records_not_in_2a_details(customer_id, insert_id)
    {
        $('#company_data').html("");
        $.ajax({
            type: "post",
