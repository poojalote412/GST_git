        ...
        <div class="box">
            <div class="box-body">
                ...
                <div id="JSFiddle" class="page-break-before page-break" style="font-family: 'Futura BdCn BT';">
                    ...
                    <!--<div id="content_letter_pdf" style="margin-top:30px;width:700px;"></div>-->
                    <!--<div id="container_image_letter_client" style="margin-top:250px;" ><img src="https://premisafe.com/GST_image/LettertoClient.jpg" width="900px" height="900px" style="page-break-before:always;"></div>-->
                            ...
                            <b> Address :Thane<br><b><br>
                                    ...
                                    <div class="test" style="page-break-before:always;margin-top:120px;">
                                        ...
                                        <div class="test" style="page-break-before:always;margin-top:30px">
                                            ...
                                            <div id="rating_card" style="width:850px"></div>
                                            <!--<div id="container_heat_map" style="width:700px"></div>-->
                                        </div>
                                        ...
                                        <div class="test" style="page-break-before:always;margin-top:50px">
                                            ...
                                            <div id="" style="width:850px">
                                                <b style="font-size:20px;color:#1d2f66;">8. SUMMARY OBSERVATION & CONCLUSION </b><br>
                                                <p>
