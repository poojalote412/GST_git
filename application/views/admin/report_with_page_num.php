...
//                            echo $report_details->about_company
                    ...
                    <div style="page-break-after:always;width:700px;margin-left: 5%;margin-right:5%;margin-top:15%;text-align: justify;text-justify: inter-word;height:800px">
                        ...
                        <table  class="table-bordered table-striped" style="width:700px">
                        ...
                        <div id="" style="width:850px">
                            ...
                            <p align="justify" style="margin-left: 5%;margin-right:  5%;font-size: 14px;letter-spacing: 0.5px;">
                                ...
                                if ($company_details->visible_customer_detail == 1) {
                                    ...
                                    echo'<p style="margin-left: 7%;margin-right:  5%;font-size: 14px;text-align: justify;">' .$company_details->compliments_conclusion_summary.'</p>';
                                    echo '<br>';
                                    echo '<h5 style="margin-left: 5%"><b>Serious Problems:</b></h5>';
                                    echo '<p style="margin-left: 7%;margin-right:  5%;font-size: 14px;text-align: justify;">' .$company_details->serious_conclusion_summary.'</p>';
                                    echo '<br>';
                                    echo '<h5 style="margin-left: 5%"><b>Improvement:</b></h5>';
                                    echo '<p style="margin-left: 7%;margin-right:  5%;font-size: 14px;text-align: justify;">' .$company_details->improvement_conclusion_summary.'</p>';
                                } else {
                                    echo "XXX";
                                }
