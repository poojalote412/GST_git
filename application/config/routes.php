...
$route['sale_nil_zero_rated'] = 'Management_report/sale_nil_zero_rated_fun';
$route['sale_rate_wise'] = 'Management_report/sale_rate_wise_fun';
$route['enter_detail_hq/(:any)/(:any)'] = 'report/enter_detail_fun_hq/$1/$2';
$route['Generate_report_hq/(:any)/(:any)'] = 'Report/index_hq/$1/$2';
$route['Generate_report_with_page_num_hq/(:any)/(:any)'] = 'Report/report_with_page_num_hq/$1/$2';
$route['update_detail_hq/(:any)/(:any)'] = 'Report/update_detail_fun_hq/$1/$2';
